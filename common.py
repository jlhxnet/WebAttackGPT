...
#================================== 路径 ===============================
# 程序根目录
rootpath ="/home/mygpu/projects/webattackgpt/"
# 词表路径
vocab_path = f"{rootpath}vocab.pth"
# 模型路径
model_path = f"{rootpath}gpt_model.pth"
# 数据集路径
dataset_path = f"{rootpath}dataset/"
csic_dataset_path =  f"{rootpath}csicdataset/"
owasp_dataset_path = f"{rootpath}owaspdataset/"
# 损失曲线图路径
